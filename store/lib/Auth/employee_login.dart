...
import 'package:store/DeliveryManPages.dart';
import 'package:store/hr_views/home.dart';
                      ...
                      if(_formKey.currentState.validate()){
                        ...
                        if(employeeData == null) { setState(() => error = "Invalid email or password!"); }
                          ...
                          if(Position == "HR"){
                            ...
                            Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context)=> new Home(HRData: employeeData)),(Route<dynamic>route)=>false );
                          }
                          else if(Position == "SalesMan"){
                            //Navigate to SalesMan home Screen
                            Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context)=> new SalesManView_Product(UserData: employeeData,)),(Route<dynamic>route)=>false );
                          }
                          else{
                            //Hala
                            ...
                            //employeeData is a map holding the tuple of the employee
                            //To know it's exactly content visit lib/rest_api/ in function getEmployee check the comments
                            Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context)=> new DMHome(employeeData["Id"].toString())),(Route<dynamic>route)=>false );
                          }
                        }
                      }
                    }
