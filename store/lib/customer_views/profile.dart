...
import 'package:store/customer_views/Customer_Profile';
//***********************************************
...
class Account extends StatefulWidget {
  ...
  final int  CUSID;
  //final int  CUSID;
  Account(this.CUSID, {this.CustomerData,Key key}):super(key: key);
  @override
        ...
        child: Column(
          children: <Widget>[
            ...
            ListTiles('Personal Information', Icons.person_pin,
                    (){ Navigator.push(context,
                        MaterialPageRoute(builder: (context) => CustomerProfile(CustomerData: widget.CustomerData)));}),
            ...
            child: Align(
              child: CircleAvatar(
                ...
                backgroundImage: imageFile == null
                    ? NetworkImage("http://www.xlentdental.com/wp-content/uploads/2019/02/171-1717870_stockvader-predicted-cron-for-may-user-profile-icon-png.jpg")
