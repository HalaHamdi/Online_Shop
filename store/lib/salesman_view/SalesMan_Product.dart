...
import 'package:store/salesman_view/profile.dart';
          ...
          child: Container(
            ...
            child: ListView(
                children: [
                  ...
                  ListTiles('My Account', Icons.person, (){Navigator.push(context, MaterialPageRoute(builder: (context) => Profile( SalesManData: widget.UserData,)));}),
                  ...
                  ListTiles('Log out', Icons.backspace_outlined,(){
